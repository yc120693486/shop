			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					<td width="50%" align="center" bgColor="#f5fafe" class="ta_01">
						二级分类名称：<input  style="border:1px solid black;" type="text" name="csname" value="<s:property value="model.csname"/>" class="bg"/>
					</td>
					<td class="ta_01" bgColor="#f5fafe" colspan="3">
						所属的一级分类：
						<select name="category.cid">
							<s:iterator value="cList" var= "c">
								<option value="<s:property value="#c.cid"></s:property>" <s:if test="model.category.cid == #c.cid">selected</s:if>><s:property value="#c.cname"></s:property></option>
							</s:iterator>
						</select>
					</td>
				</tr>
