...
<div class="container productList">
	...
	<div class="pagination">
		...
		<s:iterator begin="1" end="pageBean.totalPage" var= "i">
				...
				<a href="${pageContext.request.contextPath}/product_findByCsid.action?csid=<s:property value="csid"/>&page=<s:property value="#i"/>" class="currentPage" style="cursor:pointer;">
