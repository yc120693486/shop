...
</div>	<div class="container register" margin-left="-50px">
		<div class="span24">
			<div class="wrap">
					...
					<form id="registerForm" action="${pageContext.request.contextPath}/user_regist.action"  method="post" novalidate="novalidate" onsubmit="return checkForm()">
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" id="username" name="username" class="text" maxlength="20" onblur="checkUsername()"><span id="usernamespan"></span>
								</td>
							</tr>
							<tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="password" name="rePassword" id="repassword" class="text" maxlength="20" autocomplete="off"><span id="repasswordspan"></span>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									...
									<tr>
										...
										<td>
												...
												<strong><s:fielderror fieldName="name"/></strong>
										</td>
									</tr>
