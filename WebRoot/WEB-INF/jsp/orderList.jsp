	...
	<div class="span5">
		<div class="logo">
			<a href="./网上商城/index.htm">
				<img src="${pageContext.request.contextPath}/image/logo2.png" alt="丰丰商城"/>
			</a>
		</div>
	</div>
	<div class="span9">
...
<div class="container cart">
				...
				<s:iterator value="pageBean.list" var="order">
					<tr>
						...
						<s:if test="#order.state == 1 ">
							<a href="${pageContext.request.contextPath}/order_findByOid.action?oid=<s:property  value="#order.oid"/>" style="color:red;">未付款</a>
						</s:if>
						<s:if test="#order.state == 2 ">
							已付款
						</s:if>
						<s:if test="#order.state == 3 ">
							<a href="${pageContext.request.contextPath}/order_updateState.action?oid=<s:property  value="#order.oid"/>" style="color:red;">确认收货</a>
						</s:if>
	...
	<div class="pagination">
		...
		<s:iterator begin="1" end="pageBean.totalPage" var= "i">
				...
				<a href="${pageContext.request.contextPath}/order_findByUid.action?page=<s:property value="#i"/>" class="currentPage" style="cursor:pointer;">
				<s:property value="#i"/></a>
				</s:if>
				<s:else>
					<span class="currentPage" style="border-color:white;background:white;"><s:property value="#i"/></span>
				</s:else>
		</s:iterator>
